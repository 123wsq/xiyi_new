...
public class ServerProgressFragment extends Fragment {
    ...
    public static ServerProgressFragment getInstance(){

        return new ServerProgressFragment();
    }
...
//        getOrderTask(null, 0);
    ...
    public void getOrderTask(final  RefreshLayout refreshLayout, final int type){
        ...
        param.put(ResponseKey.STATUS, "3");
