...
public class ClassicsCustomHeader extends LinearLayout implements RefreshHeader{
    ...
    public ClassicsCustomHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context);
    }
    public ClassicsCustomHeader(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mProgressView.setImageDrawable(mProgressDrawable);
        mProgressView.setBackgroundResource(R.drawable.refresh_loadding);
        mArrowView.parserPaths("M20,12l-1.41,-1.41L13,16.17V4h-2v12.17l-5.58,-5.59L4,12l8,8 8,-8z");

        addView(mProgressView, DensityUtil.dp2px(context, 40), DensityUtil.dp2px(context, 40));
