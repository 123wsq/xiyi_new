...
import com.example.wsq.android.adapter.CompanyEarningAdapter;
...
public class CompanyEarningActivity extends BaseActivity{
    ...
    private CompanyEarningAdapter mAdapter;
    ...
    public void init() {
        ...
        mAdapter = new CompanyEarningAdapter(this, mData, clickListener);
        rv_RecyclerView.setAdapter(mAdapter);


        getCompanyarningList();
        onNotDataLayout();
    }
    ...
    OnWheelViewCalendarListener listener = new OnWheelViewCalendarListener() {
        ...
        public void onWheelViewChange(String year, String month, String day) {
            ...
            getCurCompanyarningList(year, month);
        }
     ...
     * 获取公司所有的收入和支出
     */
    private void getCompanyarningList(){

        Map<String, String> param = new HashMap<>();
        param.put(ResponseKey.TOKEN, token);
        userService.onGetCompanyEarningList(this, param, new HttpResponseListener() {
            @Override
            public void onSuccess(Map<String, Object> result) {
     ...
     * 获取公司当前收入和支出
     */
    private void getCurCompanyarningList(String year, String month){
        Map<String, String> param = new HashMap<>();
        param.put(ResponseKey.TOKEN, token);
        param.put(ResponseKey.MONTH, month);
        param.put(ResponseKey.YEAR, year);
        userService.onGetCurMonthCompanyEarningList(this, param, new HttpResponseListener() {
            @Override
            public void onSuccess(Map<String, Object> result) {
