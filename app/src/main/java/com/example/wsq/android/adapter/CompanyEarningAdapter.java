...
public class CompanyEarningAdapter extends RecyclerView.Adapter<CompanyEarningAdapter.ViewHolder>{

    private Context mContext;
    private List<Map<String, Object>> mData;
    private OnDefaultClickListener mClickListener;
    public CompanyEarningAdapter(Context context, List<Map<String, Object>> list, OnDefaultClickListener clickListener){
