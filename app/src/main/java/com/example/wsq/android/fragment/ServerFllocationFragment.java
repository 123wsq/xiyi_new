...
public class ServerFllocationFragment extends Fragment {
    ...
    public static ServerFllocationFragment getInstance(){
        return new ServerFllocationFragment();
    }
...
//        getOrderTask(null, 0);
    ...
    public void getOrderTask(final  RefreshLayout refreshLayout, final int type){
        ...
        param.put(ResponseKey.STATUS, "2");
