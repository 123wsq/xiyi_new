...
//    private OnKeyListener keyListener; // 所有EditText的软键盘监听器
    ...
    private OnRemoveImageChangeListener removeImageChangeListener;
    ...
    public void createImageView(final int index, final String url){
        ...
        close.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (removeImageChangeListener != null){
                    removeImageChangeListener.onRemoveImageListener(url);
                }
            }
        });
...
//                            imageHeight = linearLayout.getWidth() * bitmap.getHeight() / bitmap.getWidth();
    ...
    public void insertImage(String imagePath) {
        ...
        if (lastEditStr.length() == 0 || editStr1.length() == 0) {
            ...
            createImageView(cursorIndex, imagePath);
        } else {
...
//                    // 文本合并
    ...
    public void onRemoveImageListener(OnRemoveImageChangeListener listener){
        this.removeImageChangeListener = listener;
    }
}
